...
class Membrane:
    ...
    def add_protein_helices(self, root_path):
        """
        Load the list of protein helices generated by nougat.tcl and save them\
        as a dict in class attribute.

        Parameters
        ----------
        root_path : Path
            The path to the directory above tcl_outputs.
