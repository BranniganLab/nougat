...
def calculate_thickness(sys_name, bead, coordsys, inclusion, polar, dims, scale_dict):
    ...
    # make plots!
    plot_maker(dim1vals, dim2vals, avgouter, sys_name, 'zone', scale_dict["thick_max"], scale_dict["thick_min"], inclusion, "avgThickness", bead, coordsys, scale_dict)
    plot_maker(dim1vals, dim2vals, avginner, sys_name, 'ztwo', scale_dict["thick_max"], scale_dict["thick_min"], inclusion, "avgThickness", bead, coordsys, scale_dict)
    plot_maker(dim1vals, dim2vals, avgwhole, sys_name, 'whole', scale_dict["thick_whole_max"], scale_dict["thick_whole_min"], inclusion, "avgThickness", bead, coordsys, scale_dict)
